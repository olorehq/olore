...
tags:
  - Playwright
sidebarTitle: Moving from Puppeteer to Playwright
---
...
See our [example on file download](/learn/playwright/file-download).
...
See our [example on file upload](/learn/playwright/testing-file-uploads).
...
For more information on selectors and how to use them, see [our dedicated guide](/learn/playwright/selectors).
...
Reusing state can [save significant amounts of time](/learn/playwright/writing-tests#keep-tests-independent) on larger suites by skipping the pre-authentication phase in scripts where it is not supposed to be directly tested / monitored.
...
![playwright inspector](/images/guides/images/guides-migration-playwright-inspector.png "Playwright Inspector")
...
![playwright trace inspection](/images/guides/images/guides-migration-playwright-trace-viewer.png "Trace inspection with Trave Viewer")
...
![page being inspected with playwright codegen](/images/guides/images/guides-migration-playwright-codegen.png "Script recording with Playwright Inspector")
...
![performance and error tracing check results on checkly](/images/docs/images/browser-checks/tracing_web_vitals.png "A browser check result with performance and error tracing")
...
<Card title="OpenAPI/Swagger Monitoring" href="/guides/monitoring-an-openapi-spec">
