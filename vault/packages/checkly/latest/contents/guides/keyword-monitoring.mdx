---
title: Creating a Keyword Monitor
sidebarTitle: Keyword Monitoring
description: With Checkly, we can use Playwright to create monitors that verify page content by checking for keywords.
tags: Playwright
---
...
![An ecommerce storefront](/images/guides/images/guide-keyword-testing-1.png "A demo ecommerce storefront")

The code for this page monitor reads as follows:

```tsx BestSeller.test.ts
...
![The checkly web UI with our keyword monitoring code](/images/guides/images/guide-keyword-testing-2.png "We can create a new browser check to get all the framing code we’ll need for this keyword monitor.")
...
![the checkly web UI with multiple frequency settings](/images/guides/images/guide-keyword-testing-3.png)
...
![The checkly web UI with multiple notification settings, described in the article text above](/images/guides/images/guide-keyword-testing-4.png)
...
![The checkly web UI showing a trace](/images/guides/images/guide-keyword-testing-5.png)
...
![The checkly web UI showing a trace](/images/guides/images/guide-keyword-testing-6.png "You can scan through this trace to see the initial content paint")
...
![our demo ecommerce storefront](/images/guides/images/guide-keyword-testing-7.png)
...
![The Checkly report showing a newly failing monitor](/images/guides/images/guide-keyword-testing-8.png "The Checkly report showing a newly failing monitor")
...
![a demo ecommerce store showing an error, with two visible offer banners](/images/guides/images/guide-keyword-testing-9.png "now our ecommerce store has two banners!")
...
```jsx BestSellerOnFrontPage.test.ts
...
```jsx BestSellerOnFrontPage.check.ts   
