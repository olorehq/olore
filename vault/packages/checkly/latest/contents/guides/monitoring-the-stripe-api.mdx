...
sidebarTitle: Monitoring the Stripe API
...
![jamstack architecture diagram](/images/guides/images/guides-checkly-jamstack-header.png "Jamstack applications heavily rely on APIs")
...
![swagger api documentation](/images/guides/images/guides-checkly-swagger.png "Swagger is a popular tool for generating API documentation")
...
![checkly dashboard with API checks](/images/guides/images/guides-checkly-dashboard-short.png "Checkly API checks shown on a dashboard")
...
![checkly check creation process](/images/guides/images/guides-checkly-stripe-check.png "Checkly API check creation")
...
![setting up assertions in an api check](/images/guides/images/guides-checkly-assertions.png "Setting up assertions for our check")
...
![setting up response time limits in an api check](/images/guides/images/guides-checkly-response-limits.png "Choosing response time limits")
...
![programmable setup scripts](/images/guides/images/guides-checkly-setup.png "Setup and teardown methods are fully scriptable using NodeJS")
...
2. [Defining our API checks as code](/guides/getting-started-with-monitoring-as-code) to scale our setup while lowering maintenance needs.
