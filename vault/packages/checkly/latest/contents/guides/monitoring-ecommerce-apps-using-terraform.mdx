---
title: How to Monitor an E-Commerce Application Using Terraform
sidebarTitle: Monitoring an E-Commerce Application with Terraform
...
We've released our brand new CLI and recommend giving it a try for the best [Monitoring as Code experience](/cli/overview).

Please visit our [documentation](/cli/cli-vs-terraform-pulumi) if you want to learn more about the pros & cons of the Terraform provider vs. the CLI for code monitoring automation.
...
![provisioning aws infrastructure - code snippet](/images/guides/images/guides-terraform-aws.png "Provisioning AWS infrastructure via Terraform")
...
![official Checkly Terraform provider on Terraform Registry](/images/guides/images/guides-provider.png "Official Checkly Terraform provider")
...
![screenshot of how to get api key from checkly dashboard](/images/guides/images/guides-terraform-api.png "Retrieving the Checkly API KEY")
...
![terraform-created checks on checkly dashboard](/images/guides/images/guides-terraform-checks.png "Terraform-provisioned checks on Checkly")
...
![terraform-created api check on checkly](/images/guides/images/guides-terraform-api-check.png "Our API and Browser checks on Checkly")
...
![terraform-created alert on checkly](/images/guides/images/guides-terraform-alerts.png "Terraform-provisioned alert on Checkly")
...
1. Iterate over existing Playwright scripts and [create multiple checks while declaring only one resource](https://www.checklyhq.com/blog/scaling-puppeteer-playwright-on-checkly-with-terraform/#iterating-through-scripts-for-shorter-config).
2. [Group checks together](https://www.checklyhq.com/blog/scaling-puppeteer-playwright-on-checkly-with-terraform/#grouping-checks-together) to better handle them in large numbers.
3. [Use code snippets](https://www.checklyhq.com/blog/scaling-puppeteer-playwright-on-checkly-with-terraform/#reducing-code-duplication-with-snippets) to avoid code duplication and reduce maintenance.
