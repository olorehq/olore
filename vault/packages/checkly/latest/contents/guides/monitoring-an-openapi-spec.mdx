...
sidebarTitle: Monitoring an OpenAPI Spec
...
![screenshot of checkly check api creation openapi import button](/images/guides/images/guides-checkly-openapi-check.png)

That will bring up the import dialog. This is where we give Checkly the URL to the Swagger/OpenAPI specification file.

![screenshot of checkly check api creation openapi import dialog](/images/guides/images/guides-checkly-openapi-dialog.png)
...
![screenshot of checkly bulk openapi import](/images/guides/images/guides-checkly-openapi-import.png)
...
![screenshot of checkly checks - with failures](/images/guides/images/guides-checkly-openapi-fail.png)
...
![screenshot of checkly filled in check body](/images/guides/images/guides-checkly-openapi-body.png)

After a small amount of tinkering, or none at all, we should have all our checks up and running.

![screenshot of checkly checks - all passing](/images/guides/images/guides-checkly-openapi-pass.png)
...
1. Learning more about [API monitoring](/learn/monitoring/api-monitoring) basics and best practices.
2. Defining our [API checks as code](/guides/getting-started-with-monitoring-as-code) to scale our setup.
