---
title: A Step-by-Step Engineering Guide for Checkly
description:
  How to get started with Checkly and Monitoring as Code.
sidebarTitle: A Step-by-Step Engineering Guide for Checkly
---
...
![a checkly dashboard](/images/guides/images/startup-tutorial-00.png)
...
![the codegen playwright inspector](/images/guides/images/startup-tutorial-01.png)
...
![a Checkly dashboard](/images/guides/images/startup-tutorial-02.png)
...
![The detail view when an API check fails](/images/guides/images/startup-tutorial-03.png)
...
![When your browser check fails, Checkly stores a Playwright trace to offer in-depth, moment-by-moment reviews of what the browser saw as it tried to load the page.](/images/guides/images/startup-tutorial-04.png)
...
![When your browser check fails, Checkly stores a Playwright trace to offer in-depth, moment-by-moment reviews of what the browser saw as it tried to load the page.](/images/guides/images/startup-tutorial-05.png)
