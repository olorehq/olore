...
6. **Run in the cloud or on-prem**. Run on the Checkly cloud or in your network using [Private Locations](/platform/private-locations/overview)
...
![CLI-deployed checks on checkly dashboard](/images/guides/images/guides-mac-cli-checks-on-checkly.png "CLI-deployed checks on Checkly")
...
![CLI-deployed api check on checkly](/images/guides/images/guides-mac-cli-api-checks-on-checkly.png "Our API and Browser Checks on Checkly")
...
![CLI-deployed alert on checkly](/images/guides/images/guides-mac-cli-alert-channels-on-checkly.png "CLI-provisioned alert on Checkly")
