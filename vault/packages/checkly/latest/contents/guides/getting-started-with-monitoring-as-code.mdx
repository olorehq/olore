...
tags: MaC
sidebarTitle: Getting Started with MaC
---
...
```bash install-checkly-cli
npm create checkly@latest
```

This command sets up all the basics to kickstart your MaC workflow in your repo.

![starting the MaC workflow in your repo](/images/guides/images/guides-getting-started-installation.png "Installing the Checkly CLI")
...
![test sessions result](/images/guides/images/guides-getting-started-testsessions.jpeg "Test Session Result")
...
![test summary](/images/guides/images/guides-getting-started-test-summary.jpeg "Test Summary Example")
...
![correct test results](/images/guides/images/guides-getting-started-correct-results.jpeg "Test Results After Updating")

If you check the detailed summary, we should have a passed test too:

![passed test screenshot](/images/guides/images/guides-getting-started-passed-test.jpeg "Screenshot of a Passed Test")
...
![checkly dashboard](/images/guides/images/guides-getting-started-project-name.jpeg "Your Project Name in the Checkly Dashboard")
