...
tags:
  - FAQ
sidebarTitle: A Guide to Uptime Monitoring
---
...
![The Checkly deploy command returning to the CLI](/images/guides/images/uptime-02.png)
...
![A Heartbeat check dashboard](/images/guides/images/uptime-03.png)
