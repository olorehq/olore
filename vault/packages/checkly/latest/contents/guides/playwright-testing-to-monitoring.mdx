...
description: Whether you're running a small startup or a large enterprise, integrating Playwright and Checkly into your workflow can transform how you approach testing and monitoring. So, start testing in production today—your users will thank you!
tags: Playwright
sidebarTitle: Playwright in Production
---
...
![a diagram showing the ideal SDLC](/images/guides/images/testing-to-monitoring-01.png)
...
![a diagram showing the SDLC with real world feedback](/images/guides/images/testing-to-monitoring-02.png)
...
![a diagram showing the ideal SDLC](/images/guides/images/testing-to-monitoring-03.png)
...
![The real dependencies of production apps](/images/guides/images/testing-to-monitoring-04.png)
...
![Checkly Dashboard with multiple Playwright Check Suites](/images/guides/images/playwright-check-suites-dashboard.png)
...
![Playwright test selection for testing and monitoring](/images/playwright-test-groups.jpg)
...
```ts checkly.config.ts highlight={9, 15}
...
```ts playwright-monitor.check.ts highlight={4,16}
