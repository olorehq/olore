---
title: Troubleshooting Auto-Waiting in Playwright
sidebarTitle: Auto-Waiting Troubleshooting
description: >-
...
![an alert telling the visitor that the modal isn't ready yet](/images/guides/images/auto-waiting-1.png)
...
![a cartoon dialogue where a developer explains to a QA person that a modal not being ready when a user clicks isn't an error](/images/guides/images/auto-waiting-2.png)
...
```ts advanced-network-waiting.spec.ts
