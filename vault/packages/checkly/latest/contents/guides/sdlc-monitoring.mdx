...
sidebarTitle: Reusing Playwright Across The SDLC
description: The same Playwright code you write for end-to-end testing before deployment, can also test code earlier as part of the dev process, and end-to-end tests can be run on a cadence in Checkly to turn test code into monitoring code.
tags: Playwright
---
...
![a diagram showing the ideal vs the real SDLC](/images/guides/images/sdlc-monitoring-01.png)
...
![a diagram showing the ideal vs the real SDLC](/images/guides/images/sdlc-monitoring-02.png)
...
![a diagram showing the ideal vs the real SDLC](/images/guides/images/sdlc-monitoring-03.png)
...
![a diagram showing Checkly integrated in dev, deploy, and monitor phases of code diaployment](/images/guides/images/sdlc-monitoring-04.png)
...
![The Checkly CLI running playwright tests from the Checkly network](/images/guides/images/sdlc-monitoring-05.png)
...
![a dashboard showing back-end requests](/images/guides/images/sdlc-monitoring-06.png)
