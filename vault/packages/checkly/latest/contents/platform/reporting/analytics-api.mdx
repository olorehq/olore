...
![analytics request with postman](/images/docs/images/analytics/analytics-request-with-postman.png)
...
![grafana data source creation](/images/docs/images/analytics/grafana-data-source-creation.png)
...
![grafana component configuration](/images/docs/images/analytics/grafana-component-configuration.png)
...
![grafana dashboard design](/images/docs/images/analytics/grafana-dashboard-design.png)
...
![google sheets apps script menu](/images/docs/images/analytics/google-sheets-apps-script-menu.png)
![google sheets apps script credentials](/images/docs/images/analytics/google-sheets-apps-script-credentials.png)
...
![google sheets report](/images/docs/images/analytics/google-sheets-reports.png)
![google sheets report summarized](/images/docs/images/analytics/google-sheets-reports-summarized.png)
...
![bash analytics output](/images/docs/images/analytics/bash-analytics.png)
