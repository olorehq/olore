...
description: 'Detailed information on specific Checkly runtimes.'
...
This runtime includes Playwright v1.58.2 and Node.js v24.13.1. New dependencies are: `axios-cookiejar-support`, `csv-parse`, `imapflow`, `mysql2`, `pdf-parse`, `tough-cookie` and `winston`. Removed: `jsdom` (you can use Playwright's built-in page APIs instead).

- [@playwright/test](https://npmjs.com/package/@playwright/test/v/1.58.2) 1.58.2
- [@axe-core/playwright](https://npmjs.com/package/@axe-core/playwright/v/4.11.1) 4.11.1
- [@azure/identity](https://npmjs.com/package/@azure/identity/v/4.13.0) 4.13.0
- [@azure/keyvault-secrets](https://npmjs.com/package/@azure/keyvault-secrets/v/4.10.0) 4.10.0
- [@checkly/playwright-helpers](https://npmjs.com/package/@checkly/playwright-helpers/v/1.0.4) 1.0.4
- [@clerk/testing](https://npmjs.com/package/@clerk/testing/v/1.14.2) 1.14.2
- [@faker-js/faker](https://npmjs.com/package/@faker-js/faker/v/10.3.0) 10.3.0
- [@google-cloud/local-auth](https://npmjs.com/package/@google-cloud/local-auth/v/3.0.1) 3.0.1
- [@kubernetes/client-node](https://npmjs.com/package/@kubernetes/client-node/v/1.4.0) 1.4.0
- [@opentelemetry/api](https://npmjs.com/package/@opentelemetry/api/v/1.9.0) 1.9.0
- [@opentelemetry/exporter-metrics-otlp-grpc](https://npmjs.com/package/@opentelemetry/exporter-metrics-otlp-grpc/v/0.212.0) 0.212.0
- [@opentelemetry/sdk-metrics](https://npmjs.com/package/@opentelemetry/sdk-metrics/v/2.5.1) 2.5.1
- [@opentelemetry/sdk-trace-base](https://npmjs.com/package/@opentelemetry/sdk-trace-base/v/2.5.1) 2.5.1
- [@t3-oss/env-nextjs](https://npmjs.com/package/@t3-oss/env-nextjs/v/0.7.3) 0.7.3
- [@xmldom/xmldom](https://npmjs.com/package/@xmldom/xmldom/v/0.9.8) 0.9.8
- [aws4](https://npmjs.com/package/aws4/v/1.13.2) 1.13.2
- [axios](https://npmjs.com/package/axios/v/1.13.5) 1.13.5
- [axios-cookiejar-support](https://npmjs.com/package/axios-cookiejar-support/v/5.0.5) 5.0.5
- [crypto-js](https://npmjs.com/package/crypto-js/v/4.2.0) 4.2.0
- [csv-parse](https://npmjs.com/package/csv-parse/v/6.1.0) 6.1.0
- [date-fns](https://npmjs.com/package/date-fns/v/4.1.0) 4.1.0
- [date-fns-tz](https://npmjs.com/package/date-fns-tz/v/3.2.0) 3.2.0
- [dotenv](https://npmjs.com/package/dotenv/v/17.3.1) 17.3.1
- [ethers](https://npmjs.com/package/ethers/v/6.16.0) 6.16.0
- [expect](https://npmjs.com/package/expect/v/30.2.0) 30.2.0
- [form-data](https://npmjs.com/package/form-data/v/4.0.5) 4.0.5
- [gaxios](https://npmjs.com/package/gaxios/v/7.1.3) 7.1.3
- [gmail-api-parse-message-ts](https://npmjs.com/package/gmail-api-parse-message-ts/v/2.2.33) 2.2.33
- [google-auth-library](https://npmjs.com/package/google-auth-library/v/10.6.1) 10.6.1
- [googleapis](https://npmjs.com/package/googleapis/v/171.4.0) 171.4.0
- [graphql](https://npmjs.com/package/graphql/v/16.13.0) 16.13.0
- [graphql-tag](https://npmjs.com/package/graphql-tag/v/2.12.6) 2.12.6
- [http](https://npmjs.com/package/http/v/24.13.1) 24.13.1
- [https](https://npmjs.com/package/https/v/24.13.1) 24.13.1
- [imapflow](https://npmjs.com/package/imapflow/v/1.2.10) 1.2.10
- [jose](https://npmjs.com/package/jose/v/6.1.3) 6.1.3
- [jsonwebtoken](https://npmjs.com/package/jsonwebtoken/v/9.0.3) 9.0.3
- [lodash](https://npmjs.com/package/lodash/v/4.17.23) 4.17.23
- [long](https://npmjs.com/package/long/v/5.3.2) 5.3.2
- [mailosaur](https://npmjs.com/package/mailosaur/v/11.0.2) 11.0.2
- [moment](https://npmjs.com/package/moment/v/2.30.1) 2.30.1
- [mysql](https://npmjs.com/package/mysql/v/2.18.1) 2.18.1
- [mysql2](https://npmjs.com/package/mysql2/v/3.18.2) 3.18.2
- [nice-grpc](https://npmjs.com/package/nice-grpc/v/2.1.14) 2.1.14
- [nice-grpc-client-middleware-deadline](https://npmjs.com/package/nice-grpc-client-middleware-deadline/v/2.0.17) 2.0.17
- [nice-grpc-client-middleware-devtools](https://npmjs.com/package/nice-grpc-client-middleware-devtools/v/1.0.9) 1.0.9
- [nice-grpc-client-middleware-retry](https://npmjs.com/package/nice-grpc-client-middleware-retry/v/3.1.13) 3.1.13
- [nice-grpc-common](https://npmjs.com/package/nice-grpc-common/v/2.0.2) 2.0.2
- [nice-grpc-error-details](https://npmjs.com/package/nice-grpc-error-details/v/0.2.12) 0.2.12
- [nice-grpc-opentelemetry](https://npmjs.com/package/nice-grpc-opentelemetry/v/0.1.20) 0.1.20
- [nice-grpc-prometheus](https://npmjs.com/package/nice-grpc-prometheus/v/0.2.9) 0.2.9
- [nice-grpc-server-health](https://npmjs.com/package/nice-grpc-server-health/v/2.0.17) 2.0.17
- [nice-grpc-server-middleware-terminator](https://npmjs.com/package/nice-grpc-server-middleware-terminator/v/2.0.16) 2.0.16
- [nice-grpc-server-reflection](https://npmjs.com/package/nice-grpc-server-reflection/v/3.0.3) 3.0.3
- [nice-grpc-web](https://npmjs.com/package/nice-grpc-web/v/3.3.9) 3.3.9
- [node-pop3](https://npmjs.com/package/node-pop3/v/0.11.0) 0.11.0
- [otpauth](https://npmjs.com/package/otpauth/v/9.5.0) 9.5.0
- [pdf-parse](https://npmjs.com/package/pdf-parse/v/1.1.1) 1.1.1
- [pdf2json](https://npmjs.com/package/pdf2json/v/4.0.2) 4.0.2
- [playwright](https://npmjs.com/package/playwright/v/1.58.2) 1.58.2
- [prisma](https://npmjs.com/package/prisma/v/7.4.1) 7.4.1
- [protobufjs](https://npmjs.com/package/protobufjs/v/8.0.0) 8.0.0
- [tedious](https://npmjs.com/package/tedious/v/19.2.1) 19.2.1
- [tough-cookie](https://npmjs.com/package/tough-cookie/v/6.0.0) 6.0.0
- [twilio](https://npmjs.com/package/twilio/v/5.12.2) 5.12.2
- [uuid](https://npmjs.com/package/uuid/v/11.1.0) 11.1.0
- [winston](https://npmjs.com/package/winston/v/3.19.0) 3.19.0
- [ws](https://npmjs.com/package/ws/v/8.19.0) 8.19.0
- [xml-crypto](https://npmjs.com/package/xml-crypto/v/6.1.2) 6.1.2
