...
![Trace with missing spans](/images/docs/images/otel/traces-missing-spans.png)
...
### Verify sampling strategy
   ...
   * **Step 2**. Confirm that your Collector pipeline uses this processor:
   ...
   Choose the specific [instrumentation language guide](/resolve/traces/instrumentation/nodejs) and review your configuration against Step 2 in the guides.
...
### Checkly Private Location setup
   When setting up Traces with a [Checkly Private Location](/platform/private-locations/overview):
...
### Incomplete instrumentation
   ...
   To see the full picture, and identify the root cause of a problem faster, ensure your applications and services are [instrumented with the OpenTelemetry SDK](/resolve/traces/instrumentation/nodejs).
