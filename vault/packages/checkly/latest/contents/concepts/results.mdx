...
The check result page will contain results from multiple locations when using [parallel scheduling](/concepts/scheduling#scheduling-strategies). Navigate between each location using the sidebar.
