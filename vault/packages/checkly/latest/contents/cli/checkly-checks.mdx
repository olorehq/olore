...
<Tip>
If your account has [Rocky AI Root Cause Analysis](/resolve/ai-root-cause-analysis/overview/) enabled, the returned error group details include the AI-generated root cause analysis for that error group.
</Tip>
