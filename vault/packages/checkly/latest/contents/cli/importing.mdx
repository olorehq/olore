---
title: 'Importing existing Checks into your CLI project'
description: 'Learn how to import checks from the UI into the CLI'
sidebarTitle: 'Importing Resources From the UI'
---
