...
![configure retry strategy](/images/docs/images/alerting/retries.png)
...
Use retries to reduce noise in your [test session results](/detect/testing/overview) while providing information about the retry attempts.
