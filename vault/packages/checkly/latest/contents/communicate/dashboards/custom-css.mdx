...
<Frame>
  <img 
    className="block dark:hidden" 
    src="/images/docs/images/dashboards-v2/aws_dashboard.png" 
    alt="Light mode interface"
  />
  <img 
    className="hidden dark:block" 
...
<Frame>
  <img 
    className="block dark:hidden" 
    src="/images/docs/images/dashboards-v2/linear_dashboard.png" 
    alt="Light mode interface"
  />
  <img 
    className="hidden dark:block" 
...
<Frame>
  <img 
    className="block dark:hidden" 
    src="/images/docs/images/dashboards-v2/kitty_dashboard.png" 
    alt="Light mode interface"
  />
  <img 
    className="hidden dark:block" 
