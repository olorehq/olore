...
<Warning>
This page describes the v1 version of the Prometheus exporter. If you are just starting with our Prometheus integration,  we recommend using our [v2 version](/integrations/observability/prometheus-v2).
</Warning>
...
![Prometheus integration step 2](/images/docs/images/integrations/prometheus_step2.png)
