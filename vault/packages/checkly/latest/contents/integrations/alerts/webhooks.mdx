...
| `IS_REMINDER`                    | Whether this alert is a reminder (`true`) or the initial alert (`false`).                                                                                                          |
| `REGION`                         | Region code where check ran, e.g. "us-east-1"                                                                                                                                  |
| `REMINDER_SEQUENCE`              | The reminder number (`0` for initial alerts, `1`+ for reminders).                                                                                                                  |
