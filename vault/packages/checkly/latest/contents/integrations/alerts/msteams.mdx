...
description: 'Configure Microsoft Teams integration to receive failure, degradation, and recovery messages from Checkly'
...
1. First, create a **Workflow**. Log in to your MS Teams account, go to Apps and search for *workflows*.
   ...
   ![setup checkly msteams_integration step 1](/images/docs/images/integrations/msteams/msteams_step1.png)
...
2. Open the *Workflows* app, go to *Create* and select the **Post to a channel when a webhook request is received** template, name your workflow, and press "Next".
   ...
   ![setup checkly msteams integration step 2](/images/docs/images/integrations/msteams/msteams_step2.png)

3. Select which *Team* and *Channel* the integration should post alert notifications to, then press "Create flow".

   ![setup checkly msteams integration step 3](/images/docs/images/integrations/msteams/msteams_step3.png)

4.  **Copy the displayed URL**. Then close the workflow setup by clicking "Done".

   ![setup checkly msteams integration step 4](/images/docs/images/integrations/msteams/msteams_step4.png)
...
5. Log in to Checkly and navigate to [Alert Settings](https://app.checklyhq.com/alert-settings/).
   ...
   ![setup checkly msteams integration step 5](/images/docs/images/integrations/msteams/msteams_step5.png)
...
which alerts you want to be notified of and which checks or check groups should be subscribed to this channel.
   ...
   ![setup checkly msteams integration step 6](/images/docs/images/integrations/msteams/msteams_step6.png)
...
Below is an example of an alert message using the default configuration.
   ...
   ![checkly msteams integration example](/images/docs/images/integrations/msteams/msteams_step7.png)
