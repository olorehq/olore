...
![vercel deployment protection](/images/docs/images/cicd/vercel/vercel_deployment_protection.png)
...
```typescript visit-protected.spec.ts
...
```javascript visit-protected.spec.js
...
the code example) to your Checkly account or as part of the [browser check's environment variables](/platform/variables).
