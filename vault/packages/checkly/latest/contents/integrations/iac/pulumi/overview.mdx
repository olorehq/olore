...
![Pulumi access token configuration screen showing a newly created token](/images/integrations/pulumi/pulumi-access-token.png)
...
![Checkly account settings showing the account ID](/images/integrations/pulumi/pulumi-account-id.png)
...
![Checkly api key section showing a newly created API key](/images/integrations/pulumi/pulumi-api-key.png)
...
![Checkly dashboard showing created checks](/images/integrations/pulumi/pulumi-created-checks.png)
