---
title: 'Pulumi Setup Guide'
description: 'Detailed setup instructions for Pulumi CLI and Checkly integration'
...
<CodeGroup>
```bash install-pulumi-npm
npm install -g @pulumi/pulumi
```

```bash install-pulumi-yarn
yarn global add @pulumi/pulumi
```

```bash install-pulumi-brew
brew install pulumi/tap/pulumi
```

```bash install-pulumi-curl
...
<CodeGroup>
```bash install-checkly-npm
npm install @checkly/pulumi
```

```bash install-checkly-yarn
...
<Columns cols={2}>
<Card title="Examples" icon="code" href="/integrations/iac/pulumi/examples">
Explore more complex examples and configurations
</Card>

<Card title="Best Practices" icon="shield-check" href="/integrations/iac/pulumi/best-practices">
Learn best practices for managing monitoring as code
</Card>

<Card title="CI/CD Integration" icon="git-merge" href="/integrations/iac/pulumi/ci-cd">
Set up automated deployments in your CI/CD pipeline
</Card>

<Card title="Troubleshooting" icon="bug" href="/integrations/iac/pulumi/setup#troubleshooting">
