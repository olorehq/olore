---
title: 'Service maintenance windows in Terraform'
sidebarTitle: 'Service Maintenance Windows'
description: 'Schedule planned maintenance windows to prevent checks from running during specific times'
---

With [maintenance windows](/communicate/maintenance-windows/overview) you can schedule planned maintenance for whatever you are monitoring in order to prevent your checks from running at specific times. Maintenance windows have their own resource:
