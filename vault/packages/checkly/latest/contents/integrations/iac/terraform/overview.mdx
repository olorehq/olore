...
description: 'Learn how to use the Checkly Terraform provider to declare your monitoring setup as code using HashiCorp Terraform'
---
...
![api key tab in checkly settings](/images/docs/images/terraform-provider/getting-started-1.png)
...
![account id in checkly settings](/images/docs/images/terraform-provider/getting-started-2.png)
...
![checkly dashboard with running check](/images/docs/images/terraform-provider/getting-started-3.png)
...
![checkly dashboard with running check](/images/docs/images/terraform-provider/getting-started-4.png)
