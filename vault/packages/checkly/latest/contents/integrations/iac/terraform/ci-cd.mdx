---
title: 'CI/CD pipelines for Terraform'
sidebarTitle: 'CI/CD Pipelines'
description: 'Integrate Terraform with CI/CD tools for automated monitoring setup deployment'
---
...
![checkly terraform cloud integration diagram](/images/docs/images/terraform-provider/hashicorp-terraform-checkly-horizontal.png)
...
![terraform cloud new vcs project](/images/docs/images/terraform-provider/cicd-1.png)
...
![terraform cloud auto apply](/images/docs/images/terraform-provider/cicd-2.png)
...
![terraform cloud apply report](/images/docs/images/terraform-provider/cicd-3.png)
