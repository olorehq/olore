---
title: 'Common issues with the Terraform provider'
sidebarTitle: 'Troubleshooting'
description: 'Troubleshoot common issues when using the Checkly Terraform provider'
---
...
You might have forgotten to [subscribe checks and groups](/integrations/iac/terraform/alerting#alert-channel-subscriptions) to your alert channel.
