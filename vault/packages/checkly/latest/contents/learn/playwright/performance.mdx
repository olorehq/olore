...
```ts basic-performance-navigation.spec.ts
...
```ts basic-performance-resource.spec.ts
import { test } from '@playwright/test'
...
```ts basic-performance-paint-timing.spec.ts
import { test } from '@playwright/test'
...
```ts basic-performance-layout-shift.spec.ts
import { test } from '@playwright/test'
...
```ts basic-performance-long-task.spec.ts
import { test } from '@playwright/test'
...
```ts basic-performance-emulation.spec.ts
import { test } from '@playwright/test'
