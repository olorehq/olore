...
In our web shop, we've got a login process that we want to simulate and test before doing further account actions. To open a dialog and log in, we might use some lines like the following:
