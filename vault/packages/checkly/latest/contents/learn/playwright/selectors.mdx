...
![a demo page](/images/samples/images/user-first1.png)
...
![examining the page with an inspector](/images/samples/images/user-first2.png)
...
![showing the element's role](/images/samples/images/user-first3.png)
...
![too many matches](/images/samples/images/user-first4.png)
