...
tags:
  - network
weight: 125
sidebarTitle: Mocking API Responses
learn_playwright:
  parent: "Basics"
---
...
![Our e-commerce storefront](/images/learn/images/mock-api-01.png)
...
```typescript book-details.spec.ts
...
```typescript mock-book-details.spec.ts
import { test, expect } from '@playwright/test';
...
![Our e-commerce storefront](/images/learn/images/mock-api-02.png)
...
```typescript full-mock-api.spec.ts
import { test, expect } from '@playwright/test';
...
![Our e-commerce storefront](/images/learn/images/mock-api-03.png)
...
![Our e-commerce storefront](/images/learn/images/mock-api-04.png)
...
```typescript out-of-stock-test.spec.ts
import { test, expect } from '@playwright/test';
...
![Our e-commerce storefront](/images/learn/images/mock-api-05.png)
...
![Our e-commerce storefront](/images/learn/images/mock-api-06.png)
