...
<Columns cols={2}>
  <Card
    ...
    href="/learn/incidents/what-is-incident-response/"
  >
  ...
  <Card
    ...
    href="/learn/incidents/anatomy-of-a-status-page/"
  >
...
<Columns cols={3}>
  ...
  <Card
    title="Making sure you get an alert for every detected failure"
    href="https://www.checklyhq.com/blog/never-miss-alerts/"
  >
