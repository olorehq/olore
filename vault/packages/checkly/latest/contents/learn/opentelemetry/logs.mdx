...
description: This article will go over the basics, and answer common questions for those getting started with logging in OpenTelemetry. OpenTelemetry elevates logging from isolated text snippets to fully contextualized observability data that integrates seamlessly with traces and metrics.
date: 2025-04-18
...
![A table of OpenTelemetry Frameworks](/images/learn/images/otel-frameworks.png)
