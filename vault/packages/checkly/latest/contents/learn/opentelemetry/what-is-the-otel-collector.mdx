...
![the agent model for the Otel collector](/images/learn/images/otel_collector_agent_model.png)
...
![the gateway model for the Otel collector](/images/learn/images/otel_collector_agent_model.png)
