...
description: One of the most basic features of almost any OpenTelemetry tool, is support for context propagation, a fundamental component that sends information from one service to another and allows traces to cover multiple services. Context propagation turns separate service logs into complete traces. It's what makes modern observability possible.
date: 2025-04-15
...
![A diagram of Uber’s Microservices, from a paper by Muhammad Ahsan (CC 4.0 Attribution License)](/images/learn/images/context-propagation-01.png)
...
![A checkly dashboard](/images/learn/images/context-propagation-02.png)
