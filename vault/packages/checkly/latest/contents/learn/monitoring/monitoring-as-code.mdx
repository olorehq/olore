...
displayDescription: >-
  Learn how to implement monitoring as code with Checkly's guide. Bring transparency, scalability, and efficiency to your cloud infrastructure management.
sidebarTitle: Monitoring as Code
---
...
![VS Code showing the checkly.config and a define API monitor.](/images/guides/images/guides-mac-teaser.jpg "VS Code showing the checkly.config and a define API monitor.")
