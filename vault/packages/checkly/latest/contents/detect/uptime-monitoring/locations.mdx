...
<Note>
Private locations are available on Team and Enterprise plans. See [Private Locations documentation](/platform/private-locations/overview) for setup details.
</Note>
...
<Card title="Private Locations" href="/platform/private-locations/overview">
