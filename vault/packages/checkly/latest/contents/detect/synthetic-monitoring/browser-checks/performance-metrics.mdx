...
description: 'Web Vitals for browser checks'
...
<Frame>
      <img
        ...
        src="/images/next/browser-check-performance-results-light.png"
        alt="Light mode interface"
      />
      <img
        className="hidden dark:block"
        src="/images/next/browser-check-performance-results-dark.png"
