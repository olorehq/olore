---
title: 'Setup and Teardown Scripts'
description: 'Learn how to use setup and teardown scripts to prepare requests and process responses in API checks.'
sidebarTitle: Setup and Teardown
---
...
![Checkly API check editor showing a JSON request body that uses the MY_VALUE environment variable.](/images/docs/images/api-checks/setup-env-variables.png)
