...
description: Learn how to structure and organize your Playwright Check Suites.
...
<Frame>
  <img
    className="block"
    src="/images/playwright-tests-sub-set.jpg"
    alt="Playwright Check Suites should be a subset of the entire Playwright end-to-end test suite."
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/playwright-test-groups.jpg"
    alt="Playwright Check Suites should be a subset of the entire Playwright end-to-end test suite."
  />
</Frame>
...
<Frame>
  ![Playwright Check Suites grouped by environment](/images/pwn-environment-grouping.png)
</Frame>
...
<Frame>
  ![Playwright Check Suites monitoring different application areas.](/images/pwn-use-case-grouping.png)
</Frame>
...
<Frame>
  ![Two Playwright Check Suites grouped by urgency](/images/pwn-urgency-grouping.png)
</Frame>
