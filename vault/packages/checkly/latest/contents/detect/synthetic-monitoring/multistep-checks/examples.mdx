...
This example uses environment variables to avoid sharing secrets in clear text. You can learn more about how to use environment variables in Checkly [here](/platform/variables).
