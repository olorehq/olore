...
Hover over any existing annotations to see available actions. Clicking the "pencil" button allows you to edit the description and add/remove tags - do note that timestamps can't be edited. Clicking the "trash" button permanently deletes the annotation.
