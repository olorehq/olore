...
title: Codex CLI
subtitle: Use Codex CLI with OpenRouter
headline: Integration with Codex CLI | OpenRouter
canonical-url: '[https://openrouter.ai/docs/guides/codex-cli](https://openrouter.ai/docs/guides/codex-cli)'
'og:site\_name': OpenRouter Documentation
'og:title': Codex CLI Integration - OpenRouter
'og:description': >-
Learn how to configure Codex CLI to use OpenRouter for agentic coding with
GPT-5-Codex and other models.
'og:image':
type: url
value: >-
[https://openrouter.ai/dynamic-og?title=Codex%20CLI\&description=Use%20Codex%20CLI%20with%20OpenRouter](https://openrouter.ai/dynamic-og?title=Codex%20CLI\&description=Use%20Codex%20CLI%20with%20OpenRouter)
'og:image:width': 1200
'og:image:height': 630
