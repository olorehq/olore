...
title: Red Teaming
subtitle: Policy for red teaming and adversarial testing on OpenRouter
headline: Red Teaming | Adversarial Testing Policy
canonical-url: '[https://openrouter.ai/docs/guides/red-teaming](https://openrouter.ai/docs/guides/red-teaming)'
'og:site\_name': OpenRouter Documentation
'og:title': Red Teaming - Adversarial Testing Policy
'og:description': >-
Understand OpenRouter policies on red teaming, jailbreaking, and adversarial
model testing. Learn how to get approval for legitimate security research.
'og:image':
type: url
value: >-
[https://openrouter.ai/dynamic-og?title=Red%20Teaming\&description=Adversarial%20testing%20policy%20and%20approval%20process](https://openrouter.ai/dynamic-og?title=Red%20Teaming\&description=Adversarial%20testing%20policy%20and%20approval%20process)
'og:image:width': 1200
'og:image:height': 630
