...
title: Infisical
subtitle: Automatic API Key Rotation with Infisical
headline: Infisical Integration | OpenRouter API Key Management
canonical-url: '[https://openrouter.ai/docs/guides/community/infisical](https://openrouter.ai/docs/guides/community/infisical)'
'og:site\_name': OpenRouter Documentation
'og:title': Infisical Integration - OpenRouter API Key Management
'og:description': >-
Set up automatic API key rotation for OpenRouter using Infisical. Complete
guide for secure key management and zero-downtime rotation.
'og:image':
type: url
value: >-
[https://openrouter.ai/dynamic-og?title=Infisical\&description=Automatic%20API%20Key%20Rotation](https://openrouter.ai/dynamic-og?title=Infisical\&description=Automatic%20API%20Key%20Rotation)
'og:image:width': 1200
'og:image:height': 630
