...
subtitle: Manage teams and shared resources with OpenRouter organizations
slug: use-cases/organization-management
headline: OpenRouter Organization Management | Developer Documentation
canonical-url: '[https://openrouter.ai/docs/use-cases/organization-management](https://openrouter.ai/docs/use-cases/organization-management)'
'og:site\_name': OpenRouter Documentation
'og:title': OpenRouter Organization Management
'og:description': >-
Learn how to create and manage organizations on OpenRouter for team
collaboration, shared credits, and centralized API management.
'og:image':
type: url
value: >-
[https://openrouter.ai/dynamic-og?pathname=use-cases/organization-management\&title=Organization%20Management\&description=Team%20collaboration%20and%20shared%20resources](https://openrouter.ai/dynamic-og?pathname=use-cases/organization-management\&title=Organization%20Management\&description=Team%20collaboration%20and%20shared%20resources)
'og:image:width': 1200
'og:image:height': 630
