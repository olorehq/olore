...
title: Crypto API
subtitle: Purchase credits with crypto
headline: Crypto API | Purchase Credits with Cryptocurrency
canonical-url: '[https://openrouter.ai/docs/guides/guides/crypto-api](https://openrouter.ai/docs/guides/guides/crypto-api)'
'og:site\_name': OpenRouter Documentation
'og:title': Crypto API - Cryptocurrency Payments for OpenRouter Credits
'og:description': >-
Learn how to purchase OpenRouter credits using cryptocurrency. Complete guide
to Coinbase integration, supported chains, and automated credit purchases.
'og:image':
type: url
value: >-
[https://openrouter.ai/dynamic-og?title=Crypto%20API\&description=Automated%20Cryptocurrency%20Payments](https://openrouter.ai/dynamic-og?title=Crypto%20API\&description=Automated%20Cryptocurrency%20Payments)
'og:image:width': 1200
'og:image:height': 630
