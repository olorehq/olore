...
title: Snowflake
subtitle: Send traces to Snowflake
headline: Broadcast to Snowflake | OpenRouter Observability
canonical-url: '[https://openrouter.ai/docs/guides/features/broadcast/snowflake](https://openrouter.ai/docs/guides/features/broadcast/snowflake)'
'og:site\_name': OpenRouter Documentation
'og:title': Broadcast to Snowflake - Send Traces to Your Data Warehouse
'og:description': >-
Connect Snowflake to automatically receive traces from your OpenRouter
requests. Step-by-step setup guide for Snowflake integration.
'og:image':
type: url
value: >-
[https://openrouter.ai/dynamic-og?title=Snowflake%20Broadcast\&description=Send%20traces%20to%20Snowflake](https://openrouter.ai/dynamic-og?title=Snowflake%20Broadcast\&description=Send%20traces%20to%20Snowflake)
'og:image:width': 1200
'og:image:height': 630
