...
title: Arize AI
subtitle: Send traces to Arize AI
headline: Broadcast to Arize AI | OpenRouter Observability
canonical-url: '[https://openrouter.ai/docs/guides/features/broadcast/arize](https://openrouter.ai/docs/guides/features/broadcast/arize)'
'og:site\_name': OpenRouter Documentation
'og:title': Broadcast to Arize AI - Send Traces to Arize
'og:description': >-
Connect Arize AI to automatically receive traces from your OpenRouter
requests. Step-by-step setup guide for Arize integration.
'og:image':
type: url
value: >-
[https://openrouter.ai/dynamic-og?title=Arize%20AI%20Broadcast\&description=Send%20traces%20to%20Arize%20AI](https://openrouter.ai/dynamic-og?title=Arize%20AI%20Broadcast\&description=Send%20traces%20to%20Arize%20AI)
'og:image:width': 1200
'og:image:height': 630
