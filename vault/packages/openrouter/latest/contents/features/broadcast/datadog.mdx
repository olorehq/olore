...
title: Datadog
subtitle: Send traces to Datadog
headline: Datadog Broadcast | OpenRouter Observability
canonical-url: '[https://openrouter.ai/docs/guides/features/broadcast/datadog](https://openrouter.ai/docs/guides/features/broadcast/datadog)'
'og:site\_name': OpenRouter Documentation
'og:title': Datadog Broadcast - Send Traces to Datadog LLM Observability
'og:description': >-
Connect Datadog LLM Observability to automatically receive traces from your
OpenRouter requests. Step-by-step setup guide for Datadog integration.
'og:image':
type: url
value: >-
[https://openrouter.ai/dynamic-og?title=Datadog%20Broadcast\&description=Send%20traces%20to%20Datadog%20LLM%20Observability](https://openrouter.ai/dynamic-og?title=Datadog%20Broadcast\&description=Send%20traces%20to%20Datadog%20LLM%20Observability)
'og:image:width': 1200
'og:image:height': 630
