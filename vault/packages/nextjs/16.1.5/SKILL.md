---
name: olore-nextjs-16.1.5
description: Local Next.js documentation reference (v16.1.5). Use when asked about Next.js features, App Router, Server Components, routing, data fetching, rendering, caching, styling, optimizations, configuration, or Next.js APIs.
---
