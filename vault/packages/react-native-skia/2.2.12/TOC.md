...
| `contents/canvas/` | Canvas component and contexts | 2 |
| `contents/shapes/` | Drawing shapes: paths, ellipses, boxes, polygons, vertices, atlas, patch, pictures | 8 |
...
| `contents/` (root) | Core topics: images, SVG, masks, filters, effects, video, animations | 13 |
...
| `shapes/pictures.md` | Skia Picture recording for performance |
