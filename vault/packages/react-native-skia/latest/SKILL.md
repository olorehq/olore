...
├── shapes/             # Paths, ellipses, boxes, polygons, vertices, atlas, patch (7 files)
...
└── (root)              # Images, SVG, masks, filters, effects, video, Skottie (14 files)
```
...
| Performance | `contents/pictures.md`, `contents/snapshot-views.md` |
