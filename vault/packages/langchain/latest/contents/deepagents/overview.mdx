...
- [LangGraph](/oss/langgraph/overview) - Provides the underlying graph execution and state management
- [LangChain](/oss/langchain/overview) - Tools and model integrations work seamlessly with deep agents
