...
const steps = [
  ...
  { text: "", delay: 400 },
  { text: "> olore inject prisma", delay: 1200 },
  { text: "Injected 1 package into: AGENTS.md, CLAUDE.md", delay: 300 },
  { text: "", delay: 600 },
  { text: "// Agents discover docs automatically", delay: 800 },
  { text: "// Skills invoked when needed", delay: 400 },
  { text: "", delay: 600 },
